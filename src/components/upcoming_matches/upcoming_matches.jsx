...
function Upcoming_matches() {
  return (
    <div className="  box-border ">
      <div className="border-2  text-white md:text-[25px] font-semibold p-4 border-red-700 bg-[linear-gradient(120deg,_#AC242D,_#5A0D13)]">
        ...
        <div className="border-2  md:w-[75%] sm:w-[85%] w-[95%] rounded-3xl mb-4">
          ...
          <div className="grid grid-cols-[2fr_1.5fr_2fr] ">
            <div className="">
              ...
              <div className=" px-3 md:text-[1.4rem] md:px-3 text-gray-600 ">
                Pakistan
              </div>
            </div>
            <div className=" flex flex-col justify-center items-center">
              <div className=" text-[#e72525] md:text-[25px] font-bold">
                58m 18s
              </div>
              <div className=" text-gray-500 text-[12px] md:text-[20px] font-semibold">
                1:30 AM
              </div>
            </div>
            <div className="">
              ...
              <div className=" px-3 md:text-[1.4rem] md:px-3 text-gray-600 text-right ">
                Australia
              </div>
            </div>
          </div>
